...
export const OfferCard = ({
  ...
  const productHref = `/products/${product?.handle}?seller_id=${offer.seller_id}`
  ...
  const isAddToCartDisabled = !hasPrice || !stock || isStockMaxLimitReached || isSubmitting
  ...
  return (
    <div
      className={cn(
        "relative group border rounded-sm flex flex-col justify-between p-1 w-full lg:w-[calc(20%-1rem)] min-w-[250px]",
        className
      )}
