...
export const ProductDetailsHeader = ({
  ...
  const winnerOffer = preferredOffer ?? getBuyboxWinner(variantOffers)
  const activeSeller = winnerOffer?.seller
  ...
  const isAddToCartDisabled =
    !hasOffer || !offerStock || isStockMaxLimitReached || isSubmitting
