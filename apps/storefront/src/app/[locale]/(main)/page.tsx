...
export default async function Home({
  ...
  const vendorPortalUrl =
    process.env.NEXT_PUBLIC_VENDOR_URL || "http://localhost:7001/seller/login"
  ...
  return (
    <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start text-primary">
      ...
      <Hero
       ...
       heading="Discover Black-owned brands"
       paragraph="Shop products from Black-owned businesses, all in one place. Shop with purpose."
        buttons={[
          { label: "Buy now", path: "/categories" },
          {
            label: "Wholesale for Business",
            path: vendorPortalUrl,
          },
        ]}
      />
